...
public class SimpleObject extends ElasticsearchIntegrationTest {
    ...
    private SearchRequestBuilder getRequestBuilder(String currentUserName, String connectionName) {
        return client().prepareSearch("connections")
                ...
                .setPostFilter(FilterBuilders.inFilter("connections", currentUserName))  // Filter
